...
\bibitem{definitionfctpure}
Fonction pure Wikipedia https://fr.wikipedia.org/wiki/Fonction$_$pure
\bibitem{effetdebord}
Effet de bord Wikiperdia https://fr.wikipedia.org/wiki/Effet_de_bord_(informatique)
\bibitem{avantage} 
Programmation fonctionelle avec javascript de Hassane Moustapha https://medium.com/@hkairi/programmation-fonctionnelle-avec-javascript-df4dafdbecda
\bibitem{exemplefctpure}
Le Parisien Fonction pure http://dictionnaire.sensagent.leparisien.fr/Fonction%20pure/fr-fr/
\bibitem{fctimpures}
Livre de "lire & comprendre VHDL & AMS" de De Jacques Rouillard.
